...
//    public Airlines(LocalDate date, Date departureTime, String airline, String flightNum, String destination, int gate) {
//        this.date = date;
...
//    }
    ...
    public int compareByDate(Airlines a) {
        ...
        String[] thisDate = transformDate(this.date).split("/");
        String[] paramDate = transformDate(a.getDate()).split("/");

        if (Integer.valueOf(thisDate[2]) > Integer.valueOf(paramDate[2])) {
            returnValue = 1;
    ...
    public int compareByFlightNum(Airlines a) {
        return flightNum.compareTo(a.flightNum);
    }
